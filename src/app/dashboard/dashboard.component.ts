...
export class DashboardComponent implements OnInit {
  ...
  constructor(private http: HttpClient,private jwtService: JwtService) { 
    ...
    this.http.get('http://localhost:8090/api/dashboard/count', this.myHttpOptions)
    .subscribe((stat:Statistics) => {
      this.nbDish = stat.nbDish;
      this.nbStaff = stat.nbStaff;
      this.nbCrew = stat.nbCrew;
      this.nbAirport = stat.nbAirport;
    });
